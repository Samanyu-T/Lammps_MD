...
mkdir $folder
b=2.721233684
atomsk --create bcc 3.14221 W orient 111 11-2 -110 $folder/W_unitcell_111.xsf
atomsk $folder/W_unitcell_111.xsf -duplicate 25 10 15 $folder/W_supercell_111.xsf     
atomsk $folder/W_supercell_111.xsf -dislocation "0.51*box" "0.51*box" edge Z Y $b 0.281965 $folder/W_edge_111.cfg
...
atomsk --create bcc 3.14221 W orient 11-2 1-10 111 $folder/W_unitcell_111.xsf
atomsk $folder/W_unitcell_111.xsf -duplicate 8 15 10 $folder/W_supercell_111.xsf     
